...
public class GradeSubmissionApplication implements CommandLineRunner  {
	...
	public void run(String... args) throws Exception {
		...
		Student[] students = new Student[] {
            new Student("Musty Trouble", LocalDate.parse(("1980-07-31"))),
            new Student("Aisha Peace", LocalDate.parse(("1980-03-01"))),
            new Student("Hadiza Problem", LocalDate.parse(("1979-09-19"))),
            new Student("Amina Issues", LocalDate.parse(("1980-07-30"))) 
        };
